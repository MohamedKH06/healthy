							...
							<div class="card">
								<div class="card-header">
									<div class="row">
										...
										<div class="col-auto">
											<a href="invoices.php" class="btn-right btn btn-sm btn-outline-primary">
												View All 
											</a>
										</div>
									</div>
													...
													<td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item" href="edit-invoice.php"><i class="far fa-edit me-2"></i>Edit</a>
																<a class="dropdown-item" href="view-invoice.php"><i class="far fa-eye me-2"></i>View</a>
							...
							<div class="card">
								<div class="card-header">
									<div class="row">
										...
										<div class="col-auto">
											<a href="estimates.php" class="btn-right btn btn-sm btn-outline-primary">
												View All 
											</a>
										</div>
									</div>
													...
													<td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item" href="edit-invoice.php"><i class="far fa-edit me-2"></i>Edit</a>
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-trash-alt me-2"></i>Delete</a>
																<a class="dropdown-item" href="view-estimate.php"><i class="far fa-eye me-2"></i>View</a>
