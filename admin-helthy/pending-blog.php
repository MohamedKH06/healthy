                            ...
                            <div class="blog grid-blog flex-fill">
                                ...
                                <div class="row">
                                    <div class="edit-options">
                                        <div class= "edit-delete-btn">
                                            <a href="edit-blog.php" class="text-success"  ><i class="feather-edit-3 me-1"></i> Edit</a>
                                            <a href="edit-blog.php" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="feather-trash-2 me-1"></i></i> Delete</a>
                                        </div>
                                        <div class="status-toggle">
                            ...
                            <div class="blog grid-blog flex-fill">
                                ...
                                <div class="row">
                                    <div class="edit-options">
                                        <div class= "edit-delete-btn">
                                            <a href="edit-blog.php" class="text-success"  ><i class="feather-edit-3 me-1"></i> Edit</a>
                                            <a href="edit-blog.php" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="feather-trash-2 me-1"></i> Delete</a>
                                        </div>
                                        <div class="status-toggle">
